...
export default function FormUpdateComisionVerification() {
    ...
    useEffect(() => {
        if (appComisionVerification) {
            setData(appComisionVerification);
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = window?.location?.href?.includes('localhost')
                ...
                : `https://api.fastcash-mx.com/api/users/comisionVerification/${appComisionVerification._id}`;
    ...
    return (
        <FormLayout>
            <p className='w-full text-center text-gray-950'>Editar comisión Verificación</p>
            <div className='flex flex-row justify-between w-full gap-4'>
                <div className='flex flex-row justify-center items-center'>
                    ...
                    <Input
                        type="number"
                        name="comisionPorAprobacion"
                        value={data.comisionPorAprobacion || ""}
